            ...
            <div className="relative w-64 h-64 flex items-center justify-center">
              {jugadores.map((jugador, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="w-16 h-16 rounded-full bg-gradient-to-b from-bg-tertiary via-bg-secondary to-primary/20 border-4 border-primary/40 shadow-xl flex items-center justify-center">
              ...
              <div className="relative z-10 w-32 h-32 rounded-full bg-gradient-to-b from-bg-tertiary via-bg-secondary to-primary/20 border-8 border-primary/40 shadow-2xl flex items-center justify-center">
